...
import ContactDialog1 from './contact-dialog1'
...
const Navigation2 = (props) => {
  return (
    <div className="navigation2-container1">
      <nav id="main-navigation" className="navigation-wrapper">
        <div className="navigation-container">
          ...
          <ContactDialog1
            btn={
              <Fragment>
                <span className="navigation2-text10">
            ...
            text={
              <Fragment>
                <span className="navigation2-text11">Full Name</span>
              </Fragment>
            }
            text1={
              <Fragment>
                <span className="navigation2-text12">Work Email</span>
              </Fragment>
            }
            text2={
              <Fragment>
                <span className="navigation2-text13">Primary Interest</span>
              </Fragment>
            }
            text3={
              <Fragment>
                <span className="navigation2-text14">Your Requirements</span>
              </Fragment>
            }
            sectionTitle={
              <Fragment>
                <span className="navigation2-text15">
                  Request Your Assessment
                </span>
              </Fragment>
            }
            rootClassName="contact-dialog1root-class-name"
            sectionContent={
              <Fragment>
                <span className="navigation2-text16">
          ...
          <div className="navigation-desktop-menu">
            <ul className="navigation-links-list">
              ...
              <li className="navigation-link-item">
                <div className="navigation2-thq-thq-navigation-link-elm-elm3 navigation-link">
                  <span>Strategic Corridors</span>
                </div>
              </li>
              <li className="navigation-link-item">
                <div className="navigation2-thq-thq-navigation-link-elm-elm4 navigation-link">
                  <span>Your Global Representative</span>
                </div>
              </li>
            </ul>
            <div className="navigation2-thq-thq-navigation-actions-elm-elm navigation-actions">
      ...
      <div className="navigation2-container2">
        <div className="navigation2-container3">
          <Script
    ...
    lastScroll = currentScroll
      ...
      <button type="button" className="button">
        <span>
          {props.button ?? (
            <Fragment>
              <span className="navigation2-text29">Button</span>
            </Fragment>
          )}
        </span>
      </button>
      <button type="button" className="button">
        <span>
          {props.button1 ?? (
            <Fragment>
              <span className="navigation2-text28">Button</span>
            </Fragment>
          )}
        </span>
      </button>
