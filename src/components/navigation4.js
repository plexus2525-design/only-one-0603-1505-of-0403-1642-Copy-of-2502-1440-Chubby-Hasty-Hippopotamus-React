...
import ContactDialog3 from './contact-dialog3'
import './navigation4.css'

const Navigation4 = (props) => {
  return (
    <div className="navigation4-container1">
      <nav id="main-navigation" className="navigation-wrapper">
        <div className="navigation-container">
          <a href="/" className="navigation4-link1">
            <div
          ...
          <ContactDialog3
            btn={
              <Fragment>
                <span className="navigation4-text10">
            ...
            text={
              <Fragment>
                <span className="navigation4-text11">Full Name</span>
              </Fragment>
            }
            text1={
              <Fragment>
                <span className="navigation4-text12">Work Email</span>
              </Fragment>
            }
            text2={
              <Fragment>
                <span className="navigation4-text13">Primary Interest</span>
              </Fragment>
            }
            text3={
              <Fragment>
                <span className="navigation4-text14">Your Requirements</span>
              </Fragment>
            }
            sectionTitle={
              <Fragment>
                <span className="navigation4-text15">
                  Request Your Assessment
                </span>
              </Fragment>
            }
            rootClassName="contact-dialog3root-class-name"
            sectionContent={
              <Fragment>
                <span className="navigation4-text16">
          ...
          <div className="navigation-desktop-menu">
            <ul className="navigation-links-list">
              ...
              <li className="navigation-link-item">
                <div className="navigation4-thq-thq-navigation-link-elm-elm3 navigation-link">
                  <span>Strategic Corridors</span>
                </div>
              </li>
              <li className="navigation-link-item">
                <div className="navigation4-thq-thq-navigation-link-elm-elm4 navigation-link">
                  <span>Your Global Representative</span>
                </div>
              </li>
            </ul>
            <div className="navigation4-thq-thq-navigation-actions-elm-elm navigation-actions">
      ...
      <div id="mobile-overlay" className="navigation-mobile-overlay">
        ...
        <div className="navigation-mobile-content">
          ...
          <div className="navigation-mobile-footer">
            <a href="/contact" className="navigation4-link8">
      ...
      <div className="navigation4-container2">
        <div className="navigation4-container3">
          <Script
    ...
    lastScroll = currentScroll
      ...
      <button type="button" className="button">
        <span>
          {props.button ?? (
            <Fragment>
              <span className="navigation4-text28">Button</span>
            </Fragment>
          )}
        </span>
      </button>
      <button type="button" className="button">
        <span>
          {props.button1 ?? (
            <Fragment>
              <span className="navigation4-text29">Button</span>
            </Fragment>
          )}
        </span>
      </button>
